...
const keyResourceList: ResourceItem[] = [
  {
    ...
    icon: Stack,
    description: <>Learn about the core concepts of the Texture platform.</>,
    link: "/platform-concepts/overview",
  },
  {
    title: "Quickstart",
    icon: FastForward,
    description: <>Get started building on the Texture platform in minutes.</>,
...
const featureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Sources are primary sources of energy data that can be connected to the
        platform. Connections to Devices, Meters, and Utility Bills are all
        handled here.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Retrieve data from and send commands to individual or groups of energy
        devices.
      </>
    ),
    link: "/platform-concepts/commands",
  },
  {
    title: "Destinations",
    ...
    description: (
      <>
        Get data pushed to you from Texture in real-time and send it anywhere
        you need it, no polling required.
      </>
    ),
    link: "/platform-concepts/destinations/destinations",
  },
  {
    title: "Signals",
    icon: CellSignalFull,
    description: (
      <>
        Data from other sources that we will combine with device information for
