import { DeviceDiscoveredEvent_1_0_0 } from "@texturehq/events";
import { JsonBlock } from "../JsonBlock";
import { LedgerTable } from "../LedgerTable";
import { EventLedger } from "../../common/types";

const deviceDiscoveredEvent: DeviceDiscoveredEvent_1_0_0 = {
...
const deviceDiscoveredEventLedger: EventLedger<DeviceDiscoveredEvent_1_0_0> = {
...
export const DeviceDiscoveredEvent = () => (
  <>
    <JsonBlock data={deviceDiscoveredEvent} />
    <LedgerTable data={deviceDiscoveredEventLedger} />
  </>
);
