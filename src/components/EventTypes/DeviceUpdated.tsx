import { DeviceUpdatedEvent_1_0_0 } from "@texturehq/events";
import { JsonBlock } from "../JsonBlock";
import { LedgerTable } from "../LedgerTable";
import { EventLedger } from "../../common/types";

const deviceUpdatedEvent: DeviceUpdatedEvent_1_0_0 = {
  type: "device.updated",
  version: "1.0.0",
...
const deviceUpdatedEventLedger: EventLedger<DeviceUpdatedEvent_1_0_0> = {
...
export const DeviceUpdatedEvent = () => (
  <>
    <JsonBlock data={deviceUpdatedEvent} />
    <LedgerTable data={deviceUpdatedEventLedger} />
  </>
);
