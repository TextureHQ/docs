...
import { CustomerCreatedEvent, CommandFailedEvent, CommandSucceededEvent, DeviceUpdatedEvent, EnrollmentApprovedEvent, SiteCreatedEvent } from '@site/src/components/EventTypes';
