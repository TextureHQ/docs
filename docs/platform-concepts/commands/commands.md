...
3. You can configure a [Destination](/platform-concepts/destinations/) webhook to receive a notification when the command has been executed (and we will push out an error message if the command has failed).
