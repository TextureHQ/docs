...
Currently, the Texture platform supports the following types of devices and models.
...
I share this only to make clear that we are not just another device integration company. 
