  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
        src="https://device.cms.texture.energy/logo/Honeywell.svg" 
        alt="Honeywell logo" 
        style={{ 
          width: '100%',
          height: '100%',
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Honeywell manufactures building automation systems, smart thermostats, and energy management platforms for residential, commercial, and industrial applications. The company produces HVAC controls, energy monitoring systems, and smart home technologies. Their products optimize energy consumption, integrate renewable energy sources, and provide comprehensive building energy management solutions across various market segments.</p>
    </div>
  </div>
</div>
