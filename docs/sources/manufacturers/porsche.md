...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Porsche.svg" 
        alt="Porsche logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Porsche</h3>
      
      <p className="manufacturer-about-description">Porsche develops high-performance electric vehicles and charging systems including the Taycan electric sports car with advanced battery technology. The German manufacturer produces luxury battery electric vehicles, ultra-fast charging infrastructure, and energy management systems. Their products integrate cutting-edge battery technology and smart charging capabilities for premium residential and commercial applications.</p>
    </div>
  </div>
</div>
