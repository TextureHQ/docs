  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Citroën designs and manufactures electric vehicles and energy systems including compact EVs and charging solutions for urban mobility applications. The French manufacturer, part of Stellantis, produces battery electric vehicles, plug-in hybrids, and energy management systems. Their products focus on efficient energy utilization and smart charging integration for residential, commercial, and fleet applications.</p>
    </div>
  </div>
</div>
