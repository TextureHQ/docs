...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Citroe%C3%8Cn.svg" 
        alt="Citroen logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Citroen</h3>
      
      <p className="manufacturer-about-description">Citroën designs and manufactures electric vehicles and energy systems including compact EVs and charging solutions for urban mobility applications. The French manufacturer, part of Stellantis, produces battery electric vehicles, plug-in hybrids, and energy management systems. Their products focus on efficient energy utilization and smart charging integration for residential, commercial, and fleet applications.</p>
    </div>
  </div>
</div>
