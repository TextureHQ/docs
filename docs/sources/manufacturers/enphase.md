  ...
  <div className="manufacturer-hero-desktop">
    ...
    fontWeight: '500'
        ...
        <div style={{
          ...
          <a href="https://enphase.com/" target="_blank" rel="noopener noreferrer" style={{
            color: '#444ae1',
            textDecoration: 'none',
            fontWeight: '600',
            fontSize: '14px'
        ...
        <div className="device-types-row" style={{
          ...
          <span className="device-types-value" style={{ fontWeight: '600', color: '#1f2937', fontSize: '14px', textAlign: 'right', maxWidth: '60%' }}>Batteries, Solar Inverters</span>
        </div>
      </div>
    </div>
