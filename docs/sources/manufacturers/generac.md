  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Generac manufactures backup power systems, energy storage solutions, and smart grid technology for residential and commercial applications. The company produces standby generators, home battery systems, and energy management platforms. Their products integrate renewable energy sources with backup power capabilities, providing comprehensive energy solutions for homes, businesses, and critical infrastructure applications.</p>
    </div>
  </div>
</div>
