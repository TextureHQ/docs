...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Generac</h3>
      
      <p className="manufacturer-about-description">Generac manufactures backup power systems, energy storage solutions, and smart grid technology for residential and commercial applications. The company produces standby generators, home battery systems, and energy management platforms. Their products integrate renewable energy sources with backup power capabilities, providing comprehensive energy solutions for homes, businesses, and critical infrastructure applications.</p>
    </div>
  </div>
</div>
