  ...
  <div className="manufacturer-hero-desktop">
    ...
    fontWeight: '500'
        ...
        <div className="device-types-row" style={{
          ...
          <span className="device-types-value" style={{ fontWeight: '600', color: '#1f2937', fontSize: '14px', textAlign: 'right', maxWidth: '60%' }}>Electric Vehicles, Smart Thermostats, EV Chargers, Solar Inverters, Batteries</span>
        </div>
      </div>
    </div>
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>TextureOS is a manufacturer of energy devices supported by Texture.</p>
    </div>
  </div>
</div>
