...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Jeep.svg" 
        alt="Jeep logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Jeep</h3>
      
      <p className="manufacturer-about-description">Jeep develops electric and hybrid vehicles with integrated energy systems including the 4xe plug-in hybrid lineup and upcoming electric SUVs. The American brand, part of Stellantis, produces electrified powertrains, battery systems, and charging solutions. Their vehicles feature energy recovery systems and smart charging capabilities designed for off-road and traditional residential, commercial applications.</p>
    </div>
  </div>
</div>
