  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Jeep develops electric and hybrid vehicles with integrated energy systems including the 4xe plug-in hybrid lineup and upcoming electric SUVs. The American brand, part of Stellantis, produces electrified powertrains, battery systems, and charging solutions. Their vehicles feature energy recovery systems and smart charging capabilities designed for off-road and traditional residential, commercial applications.</p>
    </div>
  </div>
</div>
