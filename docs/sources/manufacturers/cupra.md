...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Cupra.svg" 
        alt="Cupra logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Cupra</h3>
      
      <p className="manufacturer-about-description">Cupra produces performance-oriented electric vehicles and charging solutions with advanced battery technology and energy management systems. The Spanish brand, part of SEAT and Volkswagen Group, manufactures high-performance electric and plug-in hybrid vehicles. Their systems integrate smart charging capabilities and energy recovery technology for residential and commercial applications across various market segments.</p>
    </div>
  </div>
</div>
