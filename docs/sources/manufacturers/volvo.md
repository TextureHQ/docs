...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Volvo.svg" 
        alt="Volvo logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Volvo</h3>
      
      <p className="manufacturer-about-description">Volvo produces electric vehicles, charging infrastructure, and energy management systems with focus on safety and sustainability. The Swedish manufacturer develops battery electric vehicles, plug-in hybrids, and smart charging solutions. Their products integrate advanced battery technology and energy recovery systems designed for residential, commercial, and fleet applications across premium market segments globally.</p>
    </div>
  </div>
</div>
