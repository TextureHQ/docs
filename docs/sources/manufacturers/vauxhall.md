...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Vauxhall.svg" 
        alt="Vauxhall logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Vauxhall</h3>
      
      <p className="manufacturer-about-description">Vauxhall produces electric vehicles and energy systems including compact EVs and charging solutions for UK mobility applications. The British manufacturer, part of Stellantis, develops battery electric vehicles, plug-in hybrids, and energy management systems. Their products focus on practical electric mobility with smart charging integration and energy-efficient powertrains for residential and commercial applications.</p>
    </div>
  </div>
</div>
