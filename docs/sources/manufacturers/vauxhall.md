  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Vauxhall produces electric vehicles and energy systems including compact EVs and charging solutions for UK mobility applications. The British manufacturer, part of Stellantis, develops battery electric vehicles, plug-in hybrids, and energy management systems. Their products focus on practical electric mobility with smart charging integration and energy-efficient powertrains for residential and commercial applications.</p>
    </div>
  </div>
</div>
