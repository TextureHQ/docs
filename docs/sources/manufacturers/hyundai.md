...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Hyundai.svg" 
        alt="Hyundai logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Hyundai</h3>
      
      <p className="manufacturer-about-description">Hyundai produces electric vehicles, hydrogen fuel cell systems, and charging infrastructure with advanced battery technology and energy management capabilities. The South Korean manufacturer develops battery electric vehicles, plug-in hybrids, and hydrogen-powered systems. Their products integrate smart charging, vehicle-to-grid technology, and renewable energy systems for residential, commercial, and fleet applications.</p>
    </div>
  </div>
</div>
