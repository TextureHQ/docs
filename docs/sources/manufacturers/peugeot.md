  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Peugeot manufactures electric vehicles and energy systems including the e-208 and e-2008 electric models with integrated charging and energy management capabilities. The French automaker, part of Stellantis, produces battery electric vehicles, plug-in hybrids, and charging infrastructure. Their systems optimize energy consumption and integrate smart charging technology for residential, commercial, and fleet applications.</p>
    </div>
  </div>
</div>
