...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Daikin</h3>
      
      <p className="manufacturer-about-description">Daikin manufactures advanced heat pump systems, HVAC equipment, and energy management solutions for residential and commercial applications. The Japanese company produces high-efficiency heating, cooling, and hot water systems with smart grid integration capabilities. Their products include air-source heat pumps, geothermal systems, and building energy management platforms that optimize energy consumption and support renewable energy integration.</p>
    </div>
  </div>
</div>
