...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Renault.svg" 
        alt="Renault logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Renault</h3>
      
      <p className="manufacturer-about-description">Renault manufactures electric vehicles and energy systems including the Zoe electric car and comprehensive charging infrastructure solutions. The French automaker produces battery electric vehicles, energy storage systems, and smart charging platforms. Their products integrate renewable energy sources and vehicle-to-grid technology for residential, commercial, and fleet applications across various European market segments.</p>
    </div>
  </div>
</div>
