  ...
  <div className="manufacturer-hero-desktop">
    ...
    fontWeight: '500'
        ...
        <div className="device-types-row" style={{
          ...
          <span className="device-types-value" style={{ fontWeight: '600', color: '#1f2937', fontSize: '14px', textAlign: 'right', maxWidth: '60%' }}>None</span>
        </div>
      </div>
    </div>
