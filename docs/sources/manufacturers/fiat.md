  ...
  <div className="manufacturer-hero-desktop">
    ...
    <div style={{
      ...
      <p style={{
        ...
        lineHeight: '1.6',
        color: '#4b5563'
      }}>Fiat produces electric vehicles and energy systems including the 500e electric car with integrated charging and energy management capabilities. The Italian manufacturer, part of Stellantis, develops battery electric vehicles, home charging solutions, and smart energy systems. Their products focus on urban mobility applications with energy-efficient powertrains and charging infrastructure for residential and commercial market segments.</p>
    </div>
  </div>
</div>
