...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Alfa Romeo</h3>
      
      <p className="manufacturer-about-description">Alfa Romeo designs and manufactures premium vehicles including electric and hybrid models with integrated energy management systems. Their Tonale hybrid SUV features advanced battery technology and regenerative braking systems. The Italian automaker, part of Stellantis, produces vehicles with sophisticated energy recovery systems and electrified powertrains for both residential and commercial applications across various market segments.</p>
    </div>
  </div>
</div>
