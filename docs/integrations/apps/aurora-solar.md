  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/Aurora%20Solar.svg" 
        alt="Aurora Solar logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Aurora Solar</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">Aurora Solar provides cloud-based solar design software, sales platforms, and energy modeling tools for solar installers and developers. The company develops comprehensive design automation, proposal generation, and energy production simulation systems. Their platform streamlines solar system design, financial analysis, and project management workflows for residential, commercial, and utility-scale solar applications across global markets.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://aurorasolar.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Aurora Solar Website</span>
...
Import accurate solar designs and production estimates to streamline project analysis and customer proposals.
