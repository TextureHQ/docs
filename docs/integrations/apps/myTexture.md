  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      ...
      <div className="app-title-section">
        <h1 className="app-title">My Texture</h1>
        <div className="app-meta">
          <span className="app-category">Texture Apps</span>
    ...
    <div className="app-description-section">
      <p className="app-description">Enable a dashboard for your users to be able to log in and see their own device data on Texture</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://docs.texturehq.com/docs/home/welcome" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit My Texture Website</span>
...
Enable a dashboard for your users to be able to log in and see their own device data on Texture
