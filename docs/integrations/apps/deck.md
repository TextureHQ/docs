  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/Deck.svg" 
        alt="Deck logo" 
        className="app-logo"
      />
      </div>
    ...
    <div className="app-description-section">
      <p className="app-description">Deck develops energy analytics software, demand response platforms, and grid optimization tools for utilities and energy service providers. The company produces load forecasting systems, demand management software, and grid stability solutions. Their platforms analyze energy consumption patterns, predict demand fluctuations, and optimize grid operations for utilities, ISOs, and energy management service providers.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.deck.co/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Deck Website</span>
...
Access utility data across electricity, water, gas, waste, and telco—globally standardized and ready to scale.
