  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/derapi.svg" 
        alt="Derapi logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Derapi</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">DerAPI develops distributed energy resource management software, grid integration platforms, and energy system orchestration tools. The company provides APIs and control systems that coordinate solar, storage, electric vehicles, and smart appliances. Their platforms enable utilities, aggregators, and energy service providers to manage and optimize distributed energy resources across residential and commercial market segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://derapi.com" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Derapi Website</span>
...
Connect with a wide range of smart energy devices, unlocking insights for improved energy management and efficiency initiatives.
