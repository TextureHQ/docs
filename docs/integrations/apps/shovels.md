  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/shovels.svg" 
        alt="Shovels logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Shovels</h1>
        <div className="app-meta">
          <span className="app-category">Permits</span>
    ...
    <div className="app-description-section">
      <p className="app-description">Shovels provides construction permit data analytics, building intelligence platforms, and market research tools for energy sector applications. The company develops permitting data aggregation, construction activity tracking, and market trend analysis systems. Their platforms help solar installers, energy developers, and equipment manufacturers identify opportunities and track market activity across residential and commercial construction segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.shovels.ai" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Shovels Website</span>
...
Manage permits and compliance in the energy sector with seamless regulatory data integration.
