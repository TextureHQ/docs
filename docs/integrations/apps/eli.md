  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/eli.svg" 
        alt="Eli logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Eli</h1>
        <div className="app-meta">
          <span className="app-category">Rebates and Incentives</span>
    ...
    <div className="app-description-section">
      <p className="app-description">Eli provides energy data analytics platforms, consumption monitoring software, and optimization tools for residential and commercial energy users. The company develops smart metering integration, energy usage tracking, and efficiency recommendation systems. Their platforms help consumers understand energy consumption patterns, identify savings opportunities, and optimize energy usage across residential and small commercial market segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.eli.build/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Eli Website</span>
...
View eligible energy incentives on your Sites to unlock and capture value for you or your customers with ease.
