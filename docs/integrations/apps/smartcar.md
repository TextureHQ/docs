  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/smartcar.svg" 
        alt="Smartcar logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Smartcar</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">Smartcar provides electric vehicle connectivity APIs, fleet management platforms, and automotive data integration solutions. The company develops software infrastructure that connects electric vehicles to energy management systems, charging networks, and smart grid platforms. Their APIs enable third-party applications to monitor vehicle data, control charging, and integrate EVs with home energy systems.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://smartcar.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Smartcar Website</span>
...
Access real-time vehicle data, enabling enhanced insights and remote vehicle control for a more connected customer experience.
