  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/leap.svg" 
        alt="Leap logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Leap</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">Leap provides energy procurement software, utility bill management platforms, and cost optimization tools for commercial energy consumers. The company develops automated energy purchasing, contract analysis, and bill auditing systems. Their platforms help businesses manage energy costs, optimize procurement strategies, and navigate deregulated energy markets across commercial and industrial market segments with comprehensive energy management solutions.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.leap.energy/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Leap Website</span>
...
Enable demand response programs and access energy markets for grid flexibility.
