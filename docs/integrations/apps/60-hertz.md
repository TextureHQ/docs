  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/60HertzIcon.svg" 
        alt="60Hertz logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">60Hertz</h1>
        <div className="app-meta">
          <span className="app-category">Site Intelligence</span>
    ...
    <div className="app-description-section">
      <p className="app-description">60Hertz Energy provides a specialized CMMS platform for distributed energy resources like solar, wind, and battery storage. Founded in 2017, their solution uniquely combines real-time monitoring with maintenance workflows, enabling automated alerts and standardized procedures. The platform features offline capabilities for remote operations, AI-powered analytics, and weather-informed scheduling, serving renewable O&M providers and utilities with pricing based on installed capacity.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://60hertzenergy.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit 60Hertz Website</span>
...
60Hertz Energy provides a purpose-built CMMS platform specifically designed for managing distributed energy resources like solar, wind, battery storage, and microgrids, with unique offline capabilities for remote operations and integrated monitoring-to-maintenance workflows.
