  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/arcadia.svg" 
        alt="Arcadia logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Arcadia</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">Arcadia develops community solar platforms, clean energy marketplace solutions, and renewable energy access tools for residential consumers. The company provides subscription-based clean energy services, utility bill management, and renewable energy certificate trading systems. Their platforms enable consumers to access solar energy savings and renewable power options across various residential market segments without rooftop installations.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.arcadia.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Arcadia Website</span>
...
Easily connect with Arcadia for access to renewable energy data and sustainability initiatives.
