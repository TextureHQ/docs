  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/Palmetto.svg" 
        alt="Palmetto Energy Intelligence logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">Palmetto Energy Intelligence</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">Palmetto Energy Intelligence develops solar design software, energy storage modeling platforms, and renewable energy project management tools. The company provides comprehensive solar system design, financial analysis, and project workflow automation systems. Their platforms serve solar installers, developers, and energy service providers with tools for residential and commercial renewable energy project development and management.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://ei.docs.palmetto.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit Palmetto Energy Intelligence Website</span>
...
Access disaggregated, hourly home energy usage and scenario modeling with physics-based insights for electrification and efficiency upgrades.
