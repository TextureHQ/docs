  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/WattTime.svg" 
        alt="WattTime logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">WattTime</h1>
        <div className="app-meta">
          <span className="app-category">Emissions</span>
    ...
    <div className="app-description-section">
      <p className="app-description">WaitTime develops occupancy analytics software, demand forecasting platforms, and energy optimization tools for commercial buildings and facilities. The company provides real-time occupancy monitoring, space utilization analytics, and HVAC optimization systems. Their platforms help building operators reduce energy consumption, optimize comfort, and improve operational efficiency across commercial and institutional market segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.watttime.org/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit WattTime Website</span>
...
View carbon emissions alongside your energy device metrics to understand and optimize consumption for cleaner electricity use.
