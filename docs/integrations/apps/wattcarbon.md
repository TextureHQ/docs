  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/WattCarbon.svg" 
        alt="WattCarbon logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">WattCarbon</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">WattCarbon operates a platform for carbon credit generation, environmental impact tracking, and renewable energy certificate management. The company provides software solutions that quantify and monetize energy efficiency improvements, solar installations, and emissions reductions. Their platform serves utilities, energy developers, and building owners seeking to measure and trade environmental benefits from energy projects.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.wattcarbon.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit WattCarbon Website</span>
...
Track energy, carbon, and cost savings with certified M& for any type of demand side energy project.
