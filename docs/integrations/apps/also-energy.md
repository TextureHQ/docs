  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/also-energy-1.svg" 
        alt="AlsoEnergy logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">AlsoEnergy</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">AlsoEnergy provides solar monitoring software, energy analytics platforms, and performance management solutions for solar installations. The company develops comprehensive monitoring systems, data analytics tools, and reporting platforms for solar asset management. Their solutions enable real-time performance tracking, predictive maintenance, and energy production optimization across residential, commercial, and utility-scale solar applications for various market segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://home.alsoenergy.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit AlsoEnergy Website</span>
...
Access live inverter data for deeper performance insights and real-time alerting, keeping energy systems seamlessly connected and transparent.
