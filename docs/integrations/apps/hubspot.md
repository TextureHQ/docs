  ...
  <div className="app-hero-content">
    ...
    <div className="app-header-section">
      <div className="app-logo-container">
        <img 
        src="https://device.cms.texture.energy/logo/hubspot.svg" 
        alt="HubSpot logo" 
        className="app-logo"
      />
      </div>
      <div className="app-title-section">
        <h1 className="app-title">HubSpot</h1>
    ...
    <div className="app-description-section">
      <p className="app-description">HubSpot provides customer relationship management software, marketing automation platforms, and business development tools for energy companies and service providers. The platform includes lead management, customer communications, and sales process automation systems. Their solutions help solar installers, energy service providers, and equipment manufacturers manage customer relationships and streamline business operations across energy market segments.</p>
    </div>
    ...
    <div className="app-actions-section">
      ...
      <div className="app-action-item">
        <a href="https://www.hubspot.com/" target="_blank" rel="noopener noreferrer" className="app-external-link">
          <span className="app-external-link-text">Visit HubSpot Website</span>
...
Sync HubSpot CRM with energy data to streamline customer relationship management and lead tracking.
