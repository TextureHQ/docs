...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Ford.svg" 
        alt="Ford logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Ford</h3>
      
      <p className="manufacturer-about-description">Ford manufactures electric vehicles, charging infrastructure, and energy systems including the F-150 Lightning with bidirectional power capabilities. The American automaker produces battery electric vehicles, plug-in hybrids, and home energy systems. Their vehicles can power homes during outages and integrate with solar systems, serving residential, commercial, and fleet applications across various energy market segments.</p>
    </div>
  </div>
</div>
