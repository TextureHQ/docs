...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Sensibo</h3>
      
      <p className="manufacturer-about-description">Sensibo develops smart air conditioning controllers, HVAC automation platforms, and climate management solutions for residential and commercial applications. The company produces Wi-Fi connected AC controllers, energy monitoring systems, and automated climate optimization software. Their products integrate with smart home platforms and utility programs to reduce energy consumption and provide intelligent HVAC control across various market segments.</p>
    </div>
  </div>
</div>
