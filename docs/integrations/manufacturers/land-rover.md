...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Land%20Rover.svg" 
        alt="Land Rover logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Land Rover</h3>
      
      <p className="manufacturer-about-description">Land Rover produces luxury electric and hybrid vehicles with advanced energy management systems and charging capabilities. The British manufacturer, part of Jaguar Land Rover, develops premium electrified SUVs, battery systems, and charging infrastructure. Their vehicles integrate energy recovery technology and smart charging systems designed for high-end residential and commercial applications.</p>
    </div>
  </div>
</div>
