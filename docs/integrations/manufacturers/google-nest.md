...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Google%20Nest.svg" 
      ...
      <div className="manufacturer-details-grid">
        ...
        <div className="manufacturer-detail-row">
          ...
          <span className="status-tag status-tag--blocked">Blocked</span>
        </div>
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Google Nest</h3>
      
      <p className="manufacturer-about-description">Google Nest develops smart home energy management systems, intelligent thermostats, and home automation platforms that optimize energy consumption. The company produces Wi-Fi connected thermostats, smart sensors, and energy monitoring systems. Their products integrate with renewable energy systems and utility programs to provide automated energy savings and grid-interactive capabilities for residential applications.</p>
    </div>
  </div>
</div>
