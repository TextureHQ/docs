...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Peugeot.svg" 
        alt="Peugeot logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Peugeot</h3>
      
      <p className="manufacturer-about-description">Peugeot manufactures electric vehicles and energy systems including the e-208 and e-2008 electric models with integrated charging and energy management capabilities. The French automaker, part of Stellantis, produces battery electric vehicles, plug-in hybrids, and charging infrastructure. Their systems optimize energy consumption and integrate smart charging technology for residential, commercial, and fleet applications.</p>
    </div>
  </div>
</div>
