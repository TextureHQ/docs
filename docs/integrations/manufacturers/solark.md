...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Sol-Ark.svg" 
        alt="Sol-Ark logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Sol-Ark</h3>
      
      <p className="manufacturer-about-description">Sol-Ark manufactures hybrid solar inverters, battery storage systems, and comprehensive energy management platforms for residential and commercial applications. The company produces multi-mode inverters, lithium battery systems, and smart energy monitoring software. Their products integrate solar generation, battery storage, and grid connectivity to provide complete energy independence solutions.</p>
    </div>
  </div>
</div>
