...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Enel%20X.svg" 
        alt="Enel X logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Enel X</h3>
      
      <p className="manufacturer-about-description">Enel X develops demand response platforms, energy storage systems, and smart grid solutions for commercial, industrial, and utility-scale applications. The company provides energy management software, battery storage platforms, and grid optimization services. Their systems enable businesses and utilities to optimize energy consumption, participate in energy markets, and integrate renewable energy sources across various commercial and utility market segments.</p>
    </div>
  </div>
</div>
