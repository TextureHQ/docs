...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Mercedes-Benz.svg" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Mercedes Benz</h3>
      
      <p className="manufacturer-about-description">Mercedes-Benz manufactures luxury electric vehicles, charging infrastructure, and energy storage systems through their EQS and EQC electric lineup. The German automaker produces premium battery electric vehicles, plug-in hybrids, and home energy systems. Their vehicles integrate advanced battery technology, bidirectional charging capabilities, and smart energy management for high-end residential and commercial applications.</p>
    </div>
  </div>
</div>
