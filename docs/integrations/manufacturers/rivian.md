...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Rivian.svg" 
        alt="Rivian logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Rivian</h3>
      
      <p className="manufacturer-about-description">Rivian produces electric trucks and delivery vehicles with advanced battery systems and charging infrastructure for commercial and consumer applications. The American manufacturer develops battery electric pickup trucks, commercial vans, and charging networks. Their vehicles feature bidirectional power capabilities and integrated energy management systems for fleet, residential, and outdoor recreational applications.</p>
    </div>
  </div>
</div>
