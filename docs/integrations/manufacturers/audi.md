...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Audi.svg" 
        alt="Audi logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Audi</h3>
      
      <p className="manufacturer-about-description">Audi develops electric vehicles, charging infrastructure, and energy storage solutions through their e-tron product line and power-to-gas initiatives. The German manufacturer produces battery electric vehicles, plug-in hybrids, and home charging systems. Their PPE platform supports bidirectional charging capabilities, enabling vehicles to function as mobile energy storage units for residential and grid applications.</p>
    </div>
  </div>
</div>
