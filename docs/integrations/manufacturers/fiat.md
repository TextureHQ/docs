...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Fiat.svg" 
        alt="Fiat logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Fiat</h3>
      
      <p className="manufacturer-about-description">Fiat produces electric vehicles and energy systems including the 500e electric car with integrated charging and energy management capabilities. The Italian manufacturer, part of Stellantis, develops battery electric vehicles, home charging solutions, and smart energy systems. Their products focus on urban mobility applications with energy-efficient powertrains and charging infrastructure for residential and commercial market segments.</p>
    </div>
  </div>
</div>
