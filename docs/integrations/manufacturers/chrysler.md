...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Chrysler.svg" 
        alt="Chrysler logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Chrysler</h3>
      
      <p className="manufacturer-about-description">Chrysler develops electric and hybrid vehicles with integrated energy management systems as part of the Stellantis automotive group. The American manufacturer produces electrified powertrains, battery systems, and charging infrastructure solutions. Their vehicles feature energy recovery systems and smart charging capabilities designed for residential and commercial applications across various energy market segments.</p>
    </div>
  </div>
</div>
