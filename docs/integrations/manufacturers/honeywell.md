...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Honeywell</h3>
      
      <p className="manufacturer-about-description">Honeywell manufactures building automation systems, smart thermostats, and energy management platforms for residential, commercial, and industrial applications. The company produces HVAC controls, energy monitoring systems, and smart home technologies. Their products optimize energy consumption, integrate renewable energy sources, and provide comprehensive building energy management solutions across various market segments.</p>
    </div>
  </div>
</div>
