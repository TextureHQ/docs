...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Nissan.svg" 
        alt="Nissan logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Nissan</h3>
      
      <p className="manufacturer-about-description">Nissan manufactures electric vehicles and energy systems including the LEAF electric car with vehicle-to-home and vehicle-to-grid capabilities. The Japanese automaker produces battery electric vehicles, charging infrastructure, and bidirectional power systems. Their products integrate renewable energy sources and provide home backup power, serving residential, commercial, and fleet applications across various energy market segments.</p>
    </div>
  </div>
</div>
