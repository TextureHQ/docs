...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Kia.svg" 
        alt="Kia logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Kia</h3>
      
      <p className="manufacturer-about-description">Kia manufactures electric vehicles, charging solutions, and energy systems including the EV6 and Niro EV with advanced battery technology. The South Korean automaker produces battery electric vehicles, plug-in hybrids, and vehicle-to-load systems. Their products feature bidirectional charging capabilities and smart energy management for residential, commercial, and fleet applications across various market segments.</p>
    </div>
  </div>
</div>
