...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/FranklinWH.svg" 
        alt="FranklinWH logo" 
      ...
      <div className="manufacturer-details-grid">
        ...
        <div className="manufacturer-detail-row device-types-row">
          ...
          <span className="manufacturer-detail-value device-types-value">Batteries</span>
        </div>
      </div>
    </div>
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About FranklinWH</h3>
      
      <p className="manufacturer-about-description">FranklinWH produces whole-home battery systems, energy management platforms, and grid-interactive storage solutions for residential applications. The company develops integrated battery storage, smart energy management software, and backup power systems. Their platforms optimize solar energy storage, provide grid services, and deliver reliable backup power for residential and small commercial market segments.</p>
    </div>
  </div>
</div>
