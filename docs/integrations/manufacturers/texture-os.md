...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/texture_logo.svg" 
        alt="TextureOS logo" 
      ...
      <div className="manufacturer-details-grid">
        ...
        <div className="manufacturer-detail-row device-types-row">
          ...
          <span className="manufacturer-detail-value device-types-value">Batteries, EV Chargers, Electric Vehicles, Smart Thermostats, Solar Inverters</span>
        </div>
      </div>
    </div>
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About TextureOS</h3>
      
      <p className="manufacturer-about-description">TextureOS is a manufacturer of energy devices supported by Texture.</p>
    </div>
  </div>
</div>
