...
<div className="manufacturer-hero-card">
  <div className="manufacturer-hero-desktop">
    ...
    <div className="manufacturer-details-section">
      <div className="manufacturer-logo-container">
        <div className="manufacturer-logo-wrapper">
          <img 
        src="https://device.cms.texture.energy/logo/Lincoln.svg" 
        alt="Lincoln logo" 
    ...
    <div className="manufacturer-about-section">
      <h3 className="manufacturer-about-title">About Lincoln</h3>
      
      <p className="manufacturer-about-description">Lincoln produces luxury electric and hybrid vehicles with integrated energy management systems and charging capabilities. The American premium brand, part of Ford, manufactures battery electric vehicles, plug-in hybrids, and home charging solutions. Their products feature sophisticated energy systems and smart charging integration designed for high-end residential and commercial applications across luxury market segments.</p>
    </div>
  </div>
</div>
